...
el que la clave de cada cliente será su NIF, y el valor será otro diccionario con los datos del cliente (nombre, dirección,
teléfono, correo, preferente), donde preferente tendrá el valor `True` si se trata de un cliente preferente.
...
while opcion != '6':
    if opcion == '1':
        ...
        direccion = input("Introduce direccion del cliente: ")
        telefono = input("Introduce telefono del cliente: ")
